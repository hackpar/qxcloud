...
angular.module("com.2fdevs.videogular")
  .controller("vgController",
    ['$scope', '$window', 'vgConfigLoader', 'vgFullscreen', 'VG_UTILS', 'VG_STATES', 'VG_VOLUME_KEY', '$ionicPlatform', function ($scope, $window, vgConfigLoader, vgFullscreen, VG_UTILS, VG_STATES, VG_VOLUME_KEY, $ionicPlatform) {
      ...
      this.onFullScreenChange = function (event) {
              if(vgFullscreen.isFullScreen()){
                      ...
                      $scope.deregister = $ionicPlatform.registerBackButtonAction(function(e) {
                              vgFullscreen.exit();
                              return false;
                      }, 101);
              }else{
